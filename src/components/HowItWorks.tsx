...
const STEPS = [
  { n: "1", t: "Ve el demo", s: "Construimos un preview de tu sistema de IA. Gratis. Sin compromiso." },
  { n: "2", t: "Tú decides", s: "¿Te gusta? Lo configuramos. ¿No te gusta? No pagas nada. Cero riesgo." },
  { n: "3", t: "Live en 24hrs", s: "Tu IA se activa — respondiendo leads mientras duermes." },
];
