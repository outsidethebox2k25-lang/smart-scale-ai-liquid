...
const CARDS: Card[] = [
  {
    ...
    label: "SMS AI",
    title: "Scale SMS AI",
    desc: "Replies to leads in 3 seconds. 24/7.",
    dot: "#28e082",
    stat: "47 leads answered today",
  ...
  },
  {
    ...
    desc: "On your site. Qualifies and books on its own.",
    dot: "#a07cff",
    stat: "12 appointments booked today",
  ...
  },
  {
    ...
    label: "FB AI",
    title: "Scale FB AI",
    desc: "They comment → they book. On their own.",
    dot: "#5ac8fa",
    stat: "Live · 0 errors",
