...
const NODES: Node[] = [
  ...
  { id: "nn4", left: 684, top: 76, nc: "rgba(191,122,240,.18)", bc: "rgba(191,122,240,.5)", gc: "rgba(191,122,240,.4)", icon: "🤖", label: "AI", labelColor: "rgba(191,122,240,.8)", title: "Claude AI", sub: "Califica y puntúa lead", portIn: true, portOut: true },
  ...
  { id: "nn6", left: 268, top: 296, nc: "rgba(255,100,50,.18)", bc: "rgba(255,100,50,.5)", gc: "rgba(255,100,50,.4)", icon: "🧠", label: "AI Score", labelColor: "rgba(255,100,50,.8)", title: "Lead Score", sub: "Ranking de prioridad", portIn: true, portOut: true },
